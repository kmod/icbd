; RUN: opt -load ../../../../Release+Asserts/lib/icbd_passes.so -basicaa -myaa -dse -o - -S < %s | FileCheck %s
...
; CHECK-NOT: store
  ; It should know that this store is dead, despite the external function coming up:
